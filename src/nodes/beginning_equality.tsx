...
export type BeginningEqualityNodeData = {
    status: boolean,
    left: string,
    right: string
};

export function BeginningEqualityNode({id, data={status:false, left:"", right:""}}: {id:string, data:any}) {
    ...
    <div className="react-flow__node-default " style={{ padding: '10px 30px 10px 10px', width: "auto"}}>
        <div>Hypothèse de récurrence</div>
